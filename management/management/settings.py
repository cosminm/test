...
from os.path import realpath, abspath, join, dirname, exists, expanduser
...
STATIC_ROOT = _path(_SRC_ROOT, 'static')
...
SECRET_KEY = 'mv#=jo5cefcy6(a%mdzlg((e#48&amp;dvq#b2ge%!*=5t5wyssf_@'
